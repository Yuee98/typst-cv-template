...
3. Prepare code, legal and pricing evidence, then use the runtime validation producer for factual candidate reports. Browser input supplies only candidate/report IDs.

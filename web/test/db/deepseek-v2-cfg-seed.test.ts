...
const NON_SYSTEM_ROUTINE_AUTHORITY_SUCCESSOR_V1 = [
  ...
  ["get_admin_config_validation_candidate_v2", "p_runtime_contract_id text, p_runtime_target_id text", "f", true, "75080c0594606a927551fdd84deea8f81ec39e3633c97b071be70bdf338602d1"],
  ["record_admin_config_validation_report_v2", "p_runtime_contract_id text, p_runtime_target_id text, p_observed_code_capability_sha256 text, p_endpoint_policy_valid boolean, p_credential_binding_valid boolean, p_credential_configured boolean, p_compiled_capability_valid boolean", "f", true, "7f5229eb580dc8f574cf73192f361547b04902e019c4b0a26e0c6cc9840bf7a6"],
  ["admin_assert_policy_config_reports_v1", "p_policy_version_id uuid, p_validation_report_ids uuid[], p_at timestamp with time zone", "f", true, "45f807e92fda9340be560b5205f6a705eb670e4e162f79f10c0840ed831c4cdf"],
  ["admin_assert_candidate_policy_config_reports_v2", "p_policy ai_routing_policy_versions, p_validation_report_ids uuid[], p_at timestamp with time zone", "f", true, "9e54f2011e0ac5e9b8f9a36b447b7dcc7bc97932085e516241a4507f4a8d4316"],
  ...
  ["get_ai_polish_execution_snapshot_v5", "p_reservation_id uuid, p_user_id uuid, p_environment text, p_project_ref text", "f", true, "814ee296ef0f59fb1b1c5c4d0e30644a60ebfc227a638df6acf94486973730a9"],
  ["start_ai_polish_provider_attempt_v5", "p_reservation_id uuid, p_attempt_no integer, p_runtime_config_receipt jsonb", "f", true, "3be7fd7af2f50d5d3701859ac1b5b6f1b12d7da254b39db25007afe2f8b6f31e"],
  ...
  ["get_admin_runtime_readback_candidate_v3", "p_policy_version_id uuid, p_validation_report_ids uuid[], p_environment text, p_project_ref text", "f", true, "b52073a82dfd609618645ac26ad09bfb461bb0fa771865038d7aeaa11b922c2b"],
  ["record_admin_runtime_readback_v3", "p_environment text, p_project_ref text, p_policy_version_id uuid, p_validation_report_ids uuid[], p_expected_closing_cycle_id uuid, p_expected_control_revision bigint, p_expected_config_generation bigint", "f", true, "78021fab4d9362c8f6519240c38126f1e7a35f3fbbd96c47ba9c9ce296714fa5"],
  ["admin_cutover_authority_v3", "p_validation_report_ids uuid[], p_expected_environment_revision bigint, p_expected_control_revision bigint, p_reason text", "f", true, "543ae23a779e3cbb0ad8df8a14de086143612b52059ae2e82e107926e4354340"],
  ["admin_reopen_ai_v2", "p_environment text, p_project_ref text, p_readback_report_id uuid, p_expected_closing_cycle_id uuid, p_expected_control_revision bigint, p_expected_policy_version_id uuid, p_expected_config_generation bigint, p_reason text, p_idempotency_key uuid", "f", true, "120f8d16f6b265b08ce21ce37daec879c4c8c15c187ec13f7185dbed95a0a6b3"],
  ...
  ["admin_assert_runtime_authority_receipt_v3", "p_environment text, p_project_ref text", "f", true, "34291ccf93d9eea065f5a28d87496bec99d5602f91842918c09d9ddc51fdc362"],
  ...
  ["admin_config_validation_evidence_v2", "p_report_id uuid, p_expected_profile_version_id uuid, p_expected_price_version_id uuid, p_at timestamp with time zone", "f", true, "57277091d1a044db14461456dda65b9956affc584766f7697e40d8d8a127149e"],

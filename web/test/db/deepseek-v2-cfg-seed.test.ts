...
const NON_SYSTEM_ROUTINE_AUTHORITY_SUCCESSOR_V1 = [
  ...
  ["admin_assert_write_actor_v1", "p_environment text, p_project_ref text, p_require_recent_totp boolean", "f", true, "bfccaff7d68da6e640c9fda2e3868a9cdffd57e87294b3f6c9f3365f023b81dc"],
  ...
  // CFG-005 removes deployment admission and introduces this replacement
  // control-plane authority surface. Keep every identity and hash explicit so
  // these routines stay outside the frozen pre-CFG001 authority root.
  ["admin_guard_config_validation_report_v2", "", "f", false, "72127665a65e47a20d1d7b8dfc3889e7a5b79976049510c22afe808f68c49756"],
  ["get_admin_config_validation_candidate_v2", "p_runtime_contract_id text, p_runtime_target_id text", "f", true, "217acf990d458e0e04b7ff4e64e2e80c05c3ee4f0184afa1d157e8e3f6d0baac"],
  ["record_admin_config_validation_report_v2", "p_runtime_contract_id text, p_runtime_target_id text, p_observed_code_capability_sha256 text, p_endpoint_policy_valid boolean, p_credential_binding_valid boolean, p_credential_configured boolean, p_compiled_capability_valid boolean", "f", true, "79da906f396ca89af27934bb43e1f5ad483762ab7644b5c663813db50be93d5e"],
  ["admin_assert_policy_config_reports_v1", "p_policy_version_id uuid, p_validation_report_ids uuid[], p_at timestamp with time zone", "f", true, "bc56a1fefe9518b4ba6378ad7d030420f7cd5824384d5222b75e2e9b972bb10e"],
  ["admin_assert_candidate_policy_config_reports_v2", "p_policy ai_routing_policy_versions, p_validation_report_ids uuid[], p_at timestamp with time zone", "f", true, "72eb669452adc5ab9292b640e7ce1ce264d1fea7999ff45a40365506b96a6ce0"],
  ["validate_ai_routing_policy_candidate_v2", "p_policy ai_routing_policy_versions, p_phase text, p_at timestamp with time zone", "f", true, "b0172636287f55bb4cbc6f8ada218eb1af2b5b2785aa47750aad894745b9948a"],
  ["lock_and_validate_ai_routing_policy_candidate_v2", "p_policy ai_routing_policy_versions, p_phase text, p_at timestamp with time zone", "f", true, "83e4288d6345936d676af6b85868cebd9d64ca10060054098e58f6e5d3f27231"],
  ["get_ai_polish_execution_snapshot_v5", "p_reservation_id uuid, p_user_id uuid, p_environment text, p_project_ref text", "f", true, "a4dc8da7fff27600cda48bc8f6af80ff768c147131089cdedef969fa0e787145"],
  ["start_ai_polish_provider_attempt_v5", "p_reservation_id uuid, p_attempt_no integer, p_runtime_config_receipt jsonb", "f", true, "4b6180e372a40e1d64a981447679ce4cc715e60f422132bcc5ce26c22dc7f3b7"],
  ["start_ai_polish_provider_attempt_v5_internal", "p_reservation_id uuid, p_attempt_no integer", "f", true, "cbd082a64d29ca4533c6fe04b90cb7129adc639f4da0d8a1bcb4ea19f5cacf1d"],
  ["admin_guard_runtime_readback_report_v2", "", "f", false, "1e6c3a6acb2af2a3cafc8303f75128e91d0d9a116d246ba858b1699ae5af9948"],
  ["get_admin_runtime_readback_candidate_v3", "p_policy_version_id uuid, p_validation_report_ids uuid[], p_environment text, p_project_ref text", "f", true, "8d6526f9398d99316f8a5f51395d0df3c6c8a7d5120214ca0cd60d9889a06f20"],
  ["record_admin_runtime_readback_v3", "p_environment text, p_project_ref text, p_policy_version_id uuid, p_validation_report_ids uuid[], p_expected_closing_cycle_id uuid, p_expected_control_revision bigint, p_expected_config_generation bigint", "f", true, "1ca55fe5f0a13496253316e74e36269d579ca0942a5d340318d1b35987fe7a2b"],
  ["admin_cutover_authority_v3", "p_validation_report_ids uuid[], p_expected_environment_revision bigint, p_expected_control_revision bigint, p_reason text", "f", true, "96fec2fbb541786628212d5d512785acc0f3a0583d78b95e403a495e3614e5d3"],
  ["admin_reopen_ai_v2", "p_environment text, p_project_ref text, p_readback_report_id uuid, p_expected_closing_cycle_id uuid, p_expected_control_revision bigint, p_expected_policy_version_id uuid, p_expected_config_generation bigint, p_reason text, p_idempotency_key uuid", "f", true, "8e0eb3a0f4ad3ac9d70cb5361662f21e25f452bdaf0a9f55de93fb5b924c91b0"],
  ["admin_guard_config_lifecycle_event_v2", "", "f", false, "0868f3b6b3bada0b6ca421bc2556c0f5a4f34bd0453e6682fbdee34df0c2bd3e"],
  ["admin_guard_runtime_authority_receipt_v3", "", "f", false, "7ee035b02175f84531a22064073e2adc0657739561244e92a7a0a8804b3e8e91"],
  ["admin_assert_runtime_authority_receipt_v3", "p_environment text, p_project_ref text", "f", true, "cdbf4d4bebe8dcf881236c43ba23fb82eed405a0f60de98963b3746dae0fb3fd"],
  ["admin_seal_price_for_activation_v2", "p_environment text, p_project_ref text, p_price_version_id uuid, p_runtime_contract_id text, p_reason text, p_idempotency_key uuid", "f", true, "364603dd6d07ed01b2b7aa12bc90e88bbc34e9201128c4a4c864a88fabc62f28"],
  ["set_ai_routing_policy_pointer_v2_internal", "p_policy_version_id uuid, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "8e70dcd02a6c2e6b54ade037df64bc9b46460e17e7cf760f6f7a9d0746946c23"],
  ["clear_ai_routing_policy_pointer_v2_internal", "p_expected_policy_version_id uuid, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "9037b905c315a88edb45c21b8a64b38951d51a332afa999f652673d0eeff30e4"],
  ["admin_set_ai_routing_pointer_v2", "p_environment text, p_project_ref text, p_policy_version_id uuid, p_validation_report_ids uuid[], p_expected_control_revision bigint, p_expected_policy_version_id uuid, p_expected_config_generation bigint, p_reason text, p_idempotency_key uuid", "f", true, "0956888109120cbb2160574f1ce52101d224329c83e85ddc4e149dc349c7fb6f"],
  ["admin_clear_ai_routing_pointer_v2", "p_environment text, p_project_ref text, p_validation_report_ids uuid[], p_expected_control_revision bigint, p_expected_policy_version_id uuid, p_expected_config_generation bigint, p_reason text, p_idempotency_key uuid", "f", true, "ca4293fee7a43d0e80777b76969b40bab5468ad13dabc1cdc869c0732510d296"],
  ["admin_current_runtime_authority_manifest_v3", "", "f", true, "e8016b7c5781dfe2d7ec9a42e3b2f609b96fb509ab37f2d4e23bfda070bf870a"],
  ["admin_config_validation_evidence_v2", "p_report_id uuid, p_expected_profile_version_id uuid, p_expected_price_version_id uuid, p_at timestamp with time zone", "f", true, "b1f14356868ac68ff90e5b910b366a4fb1b455ab97096bfd6a8b015d4845a222"],
  ["admin_config_lifecycle_evidence_v2", "p_report_ids uuid[], p_runtime_contract_id text, p_at timestamp with time zone", "f", true, "f66304d0b063d293525875d2f003c22e94ccba0db4333bd5bc81fab8c037213e"],
  ["admin_insert_config_lifecycle_event_v2", "p_operation text, p_target_id uuid, p_runtime_contract_id text, p_report_ids uuid[], p_actor text, p_reason text, p_metadata jsonb", "f", true, "2b2d65c15a77cfbab2694183c2ece1f70dbf5d4564126094a3bac2a6712173f8"],
  ["transition_ai_provider_profile_version_v2_internal", "p_profile_version_id uuid, p_to_status text, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "53c421ed200f0de96c43e7f61ce23050e9aba7302010bbe6544540ddf7e84a3e"],
  ["transition_ai_routing_policy_v3_internal", "p_policy_version_id uuid, p_to_status text, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "e75fc3daeb9b6ca16ca869a58af950f988d5f760a7d71ae3a7e236406d282c3a"],
  ["validate_ai_routing_policy_transition_v2", "", "f", true, "6ca9675e10310f918bfb5c6500a259b9612a0a7e4a0b0fb45d92810673894aa9"],
  ["close_ai_price_version_v2_internal", "p_price_version_id uuid, p_valid_to timestamp with time zone, p_successor_price_version_id uuid, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "d45b37b10b7090b155b6694c299048e56274b989e2942886260958d5e4d9212d"],
  ["retire_ai_provider_profile_version_v2_internal", "p_profile_version_id uuid, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "b854281b66b25089c6f8e4aff4e525ebb934844d64c9af2c1b87631163b0cbfa"],
  ["retire_ai_provider_profile_v2_internal", "p_profile_id uuid, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "90f81a10ec1c56d70d9e7c12a38ce1b2e904db952d29dd25f453e177b3774ef5"],
  ["admin_transition_profile_version_v2", "p_environment text, p_project_ref text, p_profile_version_id uuid, p_to_status text, p_validation_report_id uuid, p_reason text, p_idempotency_key uuid", "f", true, "da056842c261dffa72aacd812e55ea34ae91b4fc5b0a052e9bfd9f20c510f845"],
  ["admin_create_routing_policy_v2", "p_environment text, p_project_ref text, p_policy_key text, p_expected_latest_version integer, p_rules jsonb, p_default_profile_version_id uuid, p_legal_bundle_version text, p_runtime_contract_id text, p_validation_report_ids uuid[], p_reason text, p_idempotency_key uuid", "f", true, "021721eeb415156ba9ad30688c289d3d59083f263f90a25fe951f7279c8456de"],
  ["admin_transition_routing_policy_v2", "p_environment text, p_project_ref text, p_policy_version_id uuid, p_to_status text, p_validation_report_ids uuid[], p_reason text, p_idempotency_key uuid", "f", true, "17d82fea8823544f2371c14401055cc5e1dd45172e2b9894de8ee68ff0a3be38"],
  ["admin_close_price_version_v2", "p_environment text, p_project_ref text, p_price_version_id uuid, p_valid_to timestamp with time zone, p_successor_price_version_id uuid, p_validation_report_id uuid, p_reason text, p_idempotency_key uuid", "f", true, "0464eb3a4aa76dad88e105d3f295eb83b35d3c83534bf0d4aeb7912061956966"],
  ["admin_retire_profile_version_v2", "p_environment text, p_project_ref text, p_profile_version_id uuid, p_validation_report_id uuid, p_reason text, p_idempotency_key uuid", "f", true, "7b790a502d488b0f7293e7cb870cb57e3ccd40264d5577968f010e9fc70cb196"],
  ["admin_retire_provider_profile_v2", "p_environment text, p_project_ref text, p_profile_id uuid, p_validation_report_id uuid, p_reason text, p_idempotency_key uuid", "f", true, "db35cef002b2597ffde3c9581406315c023b8042958f5cdf105733ac60473d6d"],
] as const;

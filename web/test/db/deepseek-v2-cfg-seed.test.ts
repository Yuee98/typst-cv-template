...
const NON_SYSTEM_ROUTINE_AUTHORITY_SUCCESSOR_V1 = [
  ...
  ["admin_assert_policy_validation_reports_v1", "p_policy_version_id uuid, p_validation_report_ids uuid[], p_at timestamp with time zone", "f", true, "556a7a2882a3ce664055ad88b4450bb298a2ef7c59d97dd540b9867e78c5f461"],
  ...
  ["admin_cutover_authority_v1", "p_reviewed_deployment_id uuid, p_validation_report_ids uuid[], p_expected_environment_revision bigint, p_expected_control_revision bigint, p_reason text", "f", true, "8853bccc7c7b4de7282b3a369aa52ceed9b079fe7be3ceb413d1c541d1d387ee"],
  ...
  ["get_ai_polish_execution_snapshot_v4", "p_reservation_id uuid, p_user_id uuid, p_environment text, p_project_ref text, p_runtime_build_id text, p_binding_manifest_revision text, p_binding_manifest_sha256 text", "f", true, "4d97e029d534ef39f2ef2a045f6dbebeb9fd47f56527818cd0a69d25d31dae45"],

...
const NON_SYSTEM_ROUTINE_AUTHORITY_SUCCESSOR_V1 = [
  ...
  ["get_admin_runtime_readback_candidate_v3", "p_policy_version_id uuid, p_validation_report_ids uuid[], p_environment text, p_project_ref text", "f", true, "04656ec41c8619a50c2d422b8054a105c712b971058ec6a4f1739a5b886610bd"],
  ["record_admin_runtime_readback_v3", "p_environment text, p_project_ref text, p_policy_version_id uuid, p_validation_report_ids uuid[], p_expected_closing_cycle_id uuid, p_expected_control_revision bigint, p_expected_config_generation bigint", "f", true, "4eb0431e5e84e8a83f63fbb633df204aa05e40c0925907d57b008477f1257d8d"],
  ["admin_cutover_authority_v3", "p_validation_report_ids uuid[], p_expected_environment_revision bigint, p_expected_control_revision bigint, p_reason text", "f", true, "ff633142abed42cdad2013879e7c80b46f40148757db30349e483809b1b71cd5"],
  ["admin_reopen_ai_v2", "p_environment text, p_project_ref text, p_readback_report_id uuid, p_expected_closing_cycle_id uuid, p_expected_control_revision bigint, p_expected_policy_version_id uuid, p_expected_config_generation bigint, p_reason text, p_idempotency_key uuid", "f", true, "6b569a1a29f24313da4d2f17a129fb58c7488ed6c6421af21242815953c8e44f"],
  ...
  ["admin_seal_price_for_activation_v2", "p_environment text, p_project_ref text, p_price_version_id uuid, p_runtime_contract_id text, p_reason text, p_idempotency_key uuid", "f", true, "6394facf4d94b56e6141774329ac654c1b7751dc524a8930eb3f2ee28cdb25ba"],
  ["set_ai_routing_policy_pointer_v2_internal", "p_policy_version_id uuid, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "3e623b317274735d42435c4f38ae7a6f00605f7164a01ca0b52a30defb4cdc9c"],
  ["clear_ai_routing_policy_pointer_v2_internal", "p_expected_policy_version_id uuid, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "f7251352b38fae6cfa5c57e49191798f0f43cb29252eaf5d7992a218665eaf6a"],
  ...
  ["admin_current_runtime_authority_manifest_v3", "", "f", true, "aa82de72e51c0b18ba9252d24e9593104beff81e8fd87878d304e3d517996b04"],
  ...
  ["transition_ai_provider_profile_version_v2_internal", "p_profile_version_id uuid, p_to_status text, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "c42cee3e3fcdaa983d5cc36c0860c681d3123b4def689786c16322c7394cad4a"],
  ["transition_ai_routing_policy_v3_internal", "p_policy_version_id uuid, p_to_status text, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "84aa9862bda3f83c34c222c2103220ebff08d8986e43b3c5dc8d5dfd0c2187c7"],
  ["close_ai_price_version_v2_internal", "p_price_version_id uuid, p_valid_to timestamp with time zone, p_successor_price_version_id uuid, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "e27e28a22aa41e9c467c90bc620b0bd6b07d43b2f573ed33f95d01a8f9db7b84"],
  ["retire_ai_provider_profile_version_v2_internal", "p_profile_version_id uuid, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "12410c96046da7fef5f15a7dcc8edd90fc7bdc7243aa1b9644fc67ccd465b185"],
  ["retire_ai_provider_profile_v2_internal", "p_profile_id uuid, p_runtime_contract_id text, p_actor text, p_reason text, p_validation_report_ids uuid[]", "f", true, "95e3f863c82319888e9820176303a2ec580cd857fac5d0430d45965858079792"],
  ...
  ["admin_create_routing_policy_v2", "p_environment text, p_project_ref text, p_policy_key text, p_expected_latest_version integer, p_rules jsonb, p_default_profile_version_id uuid, p_legal_bundle_version text, p_runtime_contract_id text, p_validation_report_ids uuid[], p_reason text, p_idempotency_key uuid", "f", true, "b9623814ca7ea2eca8b16dcb5d2d136f736cac4611edd27450051b704071dbb2"],
